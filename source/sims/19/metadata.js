...
/*******************************************************
 Simulation Model
********************************************************/
sim.model.name = "Inventory-2";
sim.model.title = "Inventory Management with a Periodic Review Policy";
...
sim.model.shortDescription = "<p>The model defines an inventory management system for a " +
    "single product shop with a <em>periodic review</em> replenishment policy. For simplicity, " +
