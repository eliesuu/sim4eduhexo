...
<div id="frontMatter">
 ...
 <h1>A Service Queue Model with Utilization and Maximum Queue Length Statistics1<a href="description.html">Read more...</a></h1>
</div>
<main>
 <div id="model-menu">
...
<%- js(['../../themes/sim4edu/source/js/metadata.js', 'metadata.js']) %>